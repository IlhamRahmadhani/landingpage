<?php include 'header.php'; ?>
        ...
        <div class="react-wrapper">
            <div class="react-wrapper-inner">
                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    ...
                                    <h1 class="breadcrumbs-title">The Challenge of <br>Global Learning Education.</h1>
                                    <ul class="user-section">
                                        <li class="user">
                                            <span><img src="assets/images/course-single/user.jpg" alt="user"></span>
                                            <span>Natasha Pawel</span>
                                        </li>
                                        <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> Dec 28, 2022</li>
                ...
                <div class="back__course__page_grid react-courses__single-page pt---110">
                    <div class="container pb---70">
                        <div class="row">
                            <div class="col-lg-8">                                
                                <div class="blog-single-inner" >
                                    <h2>Jalur Seleksi Rapor

                                    </h2>
                                    <div class="blog-content">
                                        <p>Program ini merupakan jalur penerimaan mahasiswa baru melalui evaluasi nilai rapor semester I s.d. IV dengan nilai rata-rata minimal 70.
                                        </p>

                                     <p>Peserta dari jalur ini adalah Siswa/i lulusan SMA/SMK/MA dengan tahun lulusan 2022,2023 dengan membayar biaya registrasi sebesar Rp 350.000.

                                    </p><br>

                                        <p>Pada jalur ini peserta berkesempatan untuk mendapat Potongan biaya Gemilang dan berlaku untuk semua Program studi.
                                            <br>
                                            ...
                                            <ol>
                                                <li>Klik tombol daftar, pilih jalur rapor pada jalur seleksi
                                                </li>
                                                <li>Membayar biaya registrasi Rp 350.000 
                                                </li>
                                                <li>Masukan nilai rapor semester I s.d. IV
                                                </li>
                                                <li>Melunasi biaya semester 1</li>
                                            ...
                                            <div class="row">                            
                                                <div class="single-studies col-md-4 grid-item">
                                                    <div class="inner-course">
                                                        <div class="case-img">
                                                            <a href="#" class="cate-w">April 12</a>
                                                            <img src="assets/images/blog-grid/4.jpg" alt="Course Image">
                                                        </div>
                                                        <div class="case-content">                                                    
                                                            <em class="cate-camp">Campaigns </em>                                                    
                                                            <h4 class="case-title"> <a href="coureses-single.html">The most complete <br>Thinking course the.</a></h4>
                                                ...
                                                <div class="single-studies col-md-4 grid-item">
                                                    <div class="inner-course">
                                                        <div class="case-img">
                                                            <a href="#" class="cate-w">June 22</a>
                                                            <img src="assets/images/blog-grid/5.jpg" alt="Course Image">
                                                        </div>
                                                        <div class="case-content">
                                                            <em class="cate-camp">Education</em> 
                                                            <h4 class="case-title"> <a href="coureses-single.html">Working nobetaston is <br>the Entirely free online.</a></h4>
                                                            <div class="react__user">
                                                ...
                                                <div class="single-studies col-md-4 grid-item">
                                                    <div class="inner-course">
                                                        <div class="case-img">
                                                            <a href="#" class="cate-w">May 18</a>
                                                            <img src="assets/images/blog-grid/6.jpg" alt="Course Image">
                                                        </div>
                                                        <div class="case-content">
                                                            <em class="cate-camp">Students</em>
                                                            <h4 class="case-title"> <a href="coureses-single.html">Dave conseroire is the<br> Entirely free online.</a></h4>
                                                            <div class="react__user">
                                                                <img src="assets/images/course/small-image/1.png" alt="user"> Natasha Pawel
                                                            </div>                                                    
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="author-comment">
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="image-comments"><img src="assets/images/course-single/user2.jpg" alt=""> </div>
                                                        </div>
                                                        <div class="col-lg-11">                            
                                                ...
                                                <li>
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="image-comments"><img src="assets/images/course-single/user.jpg" alt=""> </div>
                                                        </div>
                                                        <div class="col-lg-11">                                   
                                                            <div class="dsc-comments">
                                                ...
                                                <li>
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="image-comments"><img src="assets/images/course-single/user3.jpg" alt=""> </div>
                                                        </div>
                                                        <div class="col-lg-11">                                   
                                                            <div class="dsc-comments">
                                ...
                                <div class="react-sidebar ml----30">
                                    ...
                                    <div class="widget back-post">
                                        ...
                                        <ul class="related-courses">
                                            <li>
                                                <a href="coureses-single.html"><span class="post-images"><img src="assets/images/blog/4.png" alt="post"></span></a>
                                                <div class="titles">                                                    
                                            ...
                                            <li>
                                                <a href="coureses-single.html"><span class="post-images"><img src="assets/images/blog/5.png" alt="post"></span></a>                                               
                                                <div class="titles">                                                    
                                            ...
                                            <li>
                                                <a href="coureses-single.html"><span class="post-images"><img src="assets/images/blog/6.png" alt="post"></span></a>
                                                <div class="titles">                                                    
        ...
        <footer id="react-footer" class="react-footer home-main">
            <div class="footer-top">
                <div class="container">
                   <p style="color :#fff"> ©2023 <a href="#" style="color :#85171a">Admisi Universitas Bakrie.</a> All Rights Reserved</p>
                    <!-- <div class="row">
                        <div class="col-lg-3 md-mb-30">
                            <div class="footer-widget footer-widget-1">
                                <div class="footer-logo white">
                                    <a href="index.html" class="logo-text"> <img src="assets/images/footer-logo2.png" alt="logo"></a>
                                </div>
